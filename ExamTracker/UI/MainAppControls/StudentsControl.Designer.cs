namespace ExamTracker.UI.MainAppControls
{
    partial class StudentsControl
    {
		...
		private void InitializeComponent()
		{
			...
			// CancelEditButton
			// 
			CancelEditButton.BackColor = Color.Gray;
			CancelEditButton.FlatAppearance.BorderSize = 0;
			CancelEditButton.FlatStyle = FlatStyle.Flat;
			CancelEditButton.Font = new Font("Segoe UI", 20.25F, FontStyle.Bold, GraphicsUnit.Point, 0);
			CancelEditButton.Location = new Point(446, 797);
			CancelEditButton.Name = "CancelEditButton";
			CancelEditButton.Size = new Size(155, 54);
			CancelEditButton.TabIndex = 28;
			CancelEditButton.TabStop = false;
