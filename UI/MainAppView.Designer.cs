namespace ExamTracker.UI
{
    partial class MainAppView
    {
		...
		private void InitializeComponent()
		{
			...
			ClientsControlButton = new Button();
			...
			profileButton.Location = new Point(34, 423);
			...
			// 
			// ClientsControlButton
			// 
			ClientsControlButton.FlatAppearance.BorderSize = 0;
			ClientsControlButton.FlatStyle = FlatStyle.Flat;
			ClientsControlButton.Font = new Font("Segoe UI", 15.75F, FontStyle.Bold | FontStyle.Italic, GraphicsUnit.Point, 238);
			ClientsControlButton.Image = (Image)resources.GetObject("ClientsControlButton.Image");
			ClientsControlButton.ImageAlign = ContentAlignment.MiddleLeft;
			ClientsControlButton.Location = new Point(35, 366);
			ClientsControlButton.Name = "ClientsControlButton";
			ClientsControlButton.Size = new Size(163, 42);
			ClientsControlButton.TabIndex = 11;
			ClientsControlButton.Text = "Clients";
			ClientsControlButton.UseVisualStyleBackColor = true;
			ClientsControlButton.Click += ClientsControlButton_Click;
			// 
			// LogoPictureBox
			// 
			LogoPictureBox.Location = new Point(12, 688);
			LogoPictureBox.Name = "LogoPictureBox";
			LogoPictureBox.Size = new Size(218, 171);
			...
			Controls.Add(ClientsControlButton);
		...
		private Button ClientsControlButton;
