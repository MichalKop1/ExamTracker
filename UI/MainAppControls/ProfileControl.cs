...
public partial class ProfileControl : UserControl
{
    ...
    private void PasteAccountInformation()
    {
        string placeholderText = "[ Update ]";

        var account = _sessionService.CurrentAccount;
        BusinessNameBox.PlaceholderText = account.BusinessName ?? placeholderText;
        StreetAddressRichTextBox.Text = account.StreetAdress ?? string.Empty;
        CityTextBox.PlaceholderText = account.City ?? placeholderText;
        StateTextBox.PlaceholderText = account.State ?? placeholderText;
        ZipCodeTextBox.PlaceholderText = account.ZipCode ?? placeholderText;
        ContactNameTextBox.PlaceholderText = account.ContactName ?? placeholderText;
        EmailTextBox.PlaceholderText = account.Email ?? placeholderText;
        PhoneTextBox.PlaceholderText = account.PhoneNumber ?? placeholderText;
    }
