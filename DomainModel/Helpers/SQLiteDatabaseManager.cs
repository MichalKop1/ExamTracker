...
public class SQLiteDatabaseManager
{
    ...
    public SQLiteDatabaseManager(string connection)
    {
    ...
    {
		string dbFilePath = new SQLiteConnectionStringBuilder(_connectionString).DataSource;
    ...
    private void CreateTables()
    {
        ...
        tables.Add(@"CREATE TABLE IF NOT EXISTS Clients (
                        Id INTEGER PRIMARY KEY AUTOINCREMENT,
